...
import ch.admin.bit.jeap.testorchestrator.testsupport.TestCaseMockTool;
import ch.admin.bit.jeap.testorchestrator.testsupport.TestCaseRunner;
...
/**
 * Example unit test for the {@link OrderBillingHappyPath} test case using the test support classes
 * {@link TestCaseRunner} and {@link TestCaseMockTool} provided by the jeap-bptest-orchestrator maven artifact.
 */
public class OrderBillingHappyPathTest extends TestCaseTestBase {
    ...
    @Test
    void testOrderBillingHappyPath() {

        // Create test case
        OrderBillingHappyPath testCase = new OrderBillingHappyPath(testcaseRunner.getApplicationEventPublisher(),
        ...
        testCaseMockTool.mockActCall(ORDER_TEST_AGENT_NAME, () -> {
            ...
            testcaseRunner.notify(orderCreatedNotificationDto);
            NotificationDto orderClosedNotificationDto = createOrderClosedNotification(testId);
            testcaseRunner.notify(orderClosedNotificationDto);
